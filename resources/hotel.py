...
# path /hoteis?cidade=Rio de Janeiro&estrelas_min=4diaria_max=400
...
class Hotel(Resource):
	...
	def get(self, hotel_id):
		...
		if hotel:
			return hotel.json()
		return {'message': 'Hotel not found.'}, 404 # Not found error message
	...
	def put(self, hotel_id):
		...
		if hotel_encontrado:
			...
			return hotel_encontrado.json(), 200 # updated
		hotel = HotelModel(hotel_id, **dados)
		try:
			hotel.save_hotel()
		except:
	...
	def delete(self, hotel_id):
		...
		if hotel:
			try:
				...
				return {'message': 'An internal error ocurred when trying to delete hotel.'}, 500 #server internal error
